...
trait TimeDecoders {
  ...
  implicit final def decodeYearMonthDefault: Decoder[YearMonth] = decodeYearMonth(yearMonthFormatter)
...
trait TimeEncoders {
  ...
  implicit final def encodeYearMonthDefault: Encoder[YearMonth] = encodeYearMonth(yearMonthFormatter)
